...
</div>`}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.IdleBodyView=window.annexSearch.IdleBodyView||class e extends window.annexSearch.BaseView{#aQ=[];_markup=`
...
</div>`;#aR(t){let n=new window.annexSearch.ChipView(this._$annexSearchWidget),r=this.first(".chips .list");return n.set("chip",t),this.#aQ.push(n),n.mount(r),!0}#aS(){let i=this.getHelper("config").get("chips.idle")||[];if(0===i.length)return this.first(".chips").remove(),!1;for(var a of i)this.#aR(a);return!0}render(){return super.render(),this.#aS(),!0}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.EmptyResultsBodyView=window.annexSearch.EmptyResultsBodyView||class e extends window.annexSearch.BaseView{_markup=`
...
</a>`;#a_(){let t=this.#a0.bind(this);return this.click(t),!0}#aX(){return this.#a_(),this.#a1(),this.#a2(),this.#ao(),!0}#a1(){let n=this.#a3.bind(this);return this.event("focus",n),!0}#a2(){let r=this.first("img");if(null===r)return!1;let i=this.#a4.bind(this);return r.addEventListener("load",i),!0}#ao(){if(!0===this._$element.hasAttribute("href"))return!1;let a=this.#ap.bind(this);return this.event("keydown",a),!0}#a0(s){let o=this.get("hit"),u=this._$element,l={$result:u,event:s,hit:o};return this.getWebComponent().getHelper("config").triggerCallback("result.click",l),this.getWebComponent().dispatchCustomEvent("result.click",l),this.getView("root.body.results.found").setFocusedIndexByResultView(this),!0}#a3(c){let h=this.get("hit"),f=this._$element,d={$result:f,event:c,hit:h};return this.getWebComponent().getHelper("config").triggerCallback("result.focus",d),this.getWebComponent().dispatchCustomEvent("result.focus",d),this.getView("root.body.results.found").setFocusedIndexByResultView(this),this.getView("root.body.results.found").clearFocused(),this._$element.classList.add("focused"),!0}#a4(p){return this.first("img").parentNode.classList.add("loaded"),!0}#ap(g){let v=g.key;return"enter"===(v=v.toLowerCase())&&(this.simulateClick(g),!0)}#a5($){return $=this.getHelper("typesense").replaceHightlightTags($)}#a6(){let m=this.getView("root.body.results.found").getResults().indexOf(this);return this.setAttribute("data-index",m),!0}#a7(){return!0!==this._$element.hasAttribute("href")&&(this.setAttribute("tabindex",0),!0)}dispatchCopyEvent(e){let t=this.get("hit"),n=this._$element,r={$result:n,event:e,hit:t};return this.getWebComponent().getHelper("config").triggerCallback("result.copy",r),this.getWebComponent().dispatchCustomEvent("result.copy",r),this.getView("root.body.results.found").setFocusedIndexByResultView(this),!0}focus(){this._$element.focus();let e=this._$element,t=this.getView("root.body.results.found").getElement();return t.scrollTo({top:e.offsetTop-t.offsetTop-t.clientHeight/2,behavior:"smooth"}),!0}render(){let e=this.#a5.bind(this);return super.render(e),this.#a6(),this.#a7(),this.#aX(),!0}simulateClick(e){let t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window,shiftKey:e.shiftKey,metaKey:e.metaKey,ctrlKey:e.ctrlKey});return this._$element.dispatchEvent(t),!0}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.ResultsBodyView=window.annexSearch.ResultsBodyView||class e extends window.annexSearch.BaseView{_markup=`
<div data-view-name="ResultsBodyView" part="results">
</div>`;#a8(){let t=new window.annexSearch.EmptyResultsBodyView(this._$annexSearchWidget),n=this._$element;return this.setView("empty",t),t.mount(n),!0}#a9(){let r=new window.annexSearch.FoundResultsBodyView(this._$annexSearchWidget),i=this._$element;return this.setView("found",r),r.mount(i),!0}mount(e){return super.mount(e),this.#a8(),this.#a9(),!0}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.ChipView=window.annexSearch.ChipView||class e extends window.annexSearch.BaseView{_markup=`
<a data-view-name="ChipView" href="#" part="chip">
    <span class="label" part-chip-label"><%= (data.chip.label) %></span>
</a>`;constructor(e,t){super(e)}#a_(){let t=this.#a0.bind(this);return this.click(t),!0}#aX(){return this.#a_(),!0}#a0(n){n.preventDefault();let r=this.get("chip").query;return this.getWebComponent().query(r),!0}render(){return super.render(),this.#aX(),!0}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.TimerView=window.annexSearch.TimerView||class e extends window.annexSearch.BaseView{#ba=!1;#bb=null;_markup=`
<div data-view-name="TimerView" part="timer">
    <div class="remaining" part="timer-remaining"><%= (data.remaining) %></div>
</div>`;constructor(e,t){super(e),this.set("seconds",t),this.set("remaining",t),this.#bc()}#bc(){let t=this.render.bind(this);return this.addCustomEventListener("data.set.remaining",t),!0}#bd(){return this._$element.remove(),window.annexSearch.TimerUtils.remove(this),!0}#be(){if(0===this.get("remaining"))return this.hide(),!0;1===this.get("remaining")&&this.dispatchCustomEvent("complete");let n=this.get("remaining");return n-=1,this.set("remaining",n),!0}#bf(){let r=setInterval(this.#be.bind(this),1e3);return this.#bb=r,!0}hide(){this.#ba=!1,this._$element.classList.remove("visible"),clearTimeout(this.#bb);var e=this.#bd.bind(this);return this.once("transitionend",e),!0}render(){return super.render(),!0===this.#ba&&this._$element.classList.add("visible"),!0}show(){if(!0===this.#ba)return!1;this.#ba=!0,this.#bf();let e=this._$element;window.annexSearch.ElementUtils.waitForAnimation().then(function(){e.classList.add("visible")});let t=this;return new Promise(function(e,n){t.addCustomEventListener("complete",e,!0)})}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.ToastView=window.annexSearch.ToastView||class e extends window.annexSearch.BaseView{#aK=window.annexSearch.ToastUtils.getDuration();#bg=!0;#ba=!1;#bh=null;_markup=`
...
</div>`;constructor(e,t=null,n=null){super(e),this.set("title",t),this.set("message",n)}#a_(){let t=this.#a0.bind(this);return this.click(t),!0}#aX(){return this.#a_(),this.addCustomEventListener("data.set.message",this.render.bind(this)),this.addCustomEventListener("data.set.title",this.render.bind(this)),!0}#bd(){return this._$element.remove(),window.annexSearch.ToastUtils.remove(this),!0}#a0(n){return!1!==this.#bg&&(this.hide(),!0)}#bi(){let r=this.getWebComponent(),i=window.annexSearch.ToastUtils.get(r);for(let a of i)a!==this&&a.hide();return!0}#bj(){if(null===this.#aK)return!1;let s,o=setTimeout(this.hide.bind(this),this.#aK);return this.#bh=o,!0}hide(){this.#ba=!1,this._$element.classList.remove("visible"),clearTimeout(this.#bh);var e=this.#bd.bind(this);return this.once("transitionend",e),!0}render(){return super.render(),!0===this.#ba&&this._$element.classList.add("visible"),this.#aX(),!0}setDuration(e=null){return this.#aK=e,!0}setUnescapable(){return this.#bg=!1,!0}show(){if(!0===this.#ba)return!1;this.#ba=!0,this.#bi(),this.#bj();let e=this._$element;return window.annexSearch.ElementUtils.waitForAnimation().then(function(){e.classList.add("visible")}),!0}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.BrandingBarFooterView=window.annexSearch.BrandingBarFooterView||class e extends window.annexSearch.BaseView{_markup=`
...
</div>`;#bk(){let t=new window.annexSearch.BrandingBarFooterView(this._$annexSearchWidget),n=this._$element;return this.setView("brandingBar",t),t.mount(n),!0}#bl(){let r=new window.annexSearch.StatusBarFooterView(this._$annexSearchWidget),i=this._$element;return this.setView("statusBar",r),r.mount(i),!0}mount(e){return super.mount(e),this.#bl(),this.#bk(),!0}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.StatusBarFooterView=window.annexSearch.StatusBarFooterView||class e extends window.annexSearch.BaseView{_markup=`
...
</div>`}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.FieldHeaderView=window.annexSearch.FieldHeaderView||class e extends window.annexSearch.BaseView{#bm=null;#bn=!1;#bo=60;#bh=null;_markup=`
...
</div>`;#bp(){let t=this.first(".clear"),n=this.#bq.bind(this);return t.addEventListener("click",n),!0}#aX(){return this.#bp(),this.#br(),!0}#br(){let r=this.first("input"),i=this.#bs.bind(this);return r.addEventListener("input",i),!0}#bq(a){return a.preventDefault(),this.clear(),this._$annexSearchWidget.getHelper("webComponentUI").setQueryAttribute(),this.nullifyLastTypesenseSearchResponse(),this.getView("root.body.results.found").clearResults(),this.getView("root.body.results.found").getView("root").setStateKey("idle"),this._$annexSearchWidget.getHelper("config").triggerCallback("results.idle"),this._$annexSearchWidget.dispatchCustomEvent("results.idle"),!0}#bt(s,o){let u=o.getError();if("abort"===u.key)return!1;let l={error:u};this.getWebComponent().getHelper("config").triggerCallback("results.error",l),this.getWebComponent().dispatchCustomEvent("results.error",l);this.getView("root.header").hideSpinner();let c=o.getResponse();return this.#bm=c,this.getView("root").setStateKey("error"),o.logFailedEvent(),!0}#bs(h){let f=this.first("input").value.trim();return(this.getWebComponent().getHelper("webComponentUI").setQueryAttribute(),""===f)?(this.getHelper("typesense").abortLastRequest(),this.getView("root.header").hideSpinner(),this.nullifyLastTypesenseSearchResponse(),this.clear(),this.getView("root").setStateKey("idle"),this.getView("root.body.results.found").clearResults(),this.getWebComponent().getHelper("config").triggerCallback("results.idle"),this.getWebComponent().dispatchCustomEvent("results.idle"),!1):f!==this.#bm?.request_params?.q&&(this.nullifyLastTypesenseSearchResponse(),this.#bn=!1,this.getView("root.body.results.found").scrollToTop(),clearTimeout(this.#bh),this.#bh=setTimeout(this.#bu.bind(this),this.#bo),!0)}#bv(d,p){let g=p.getResponse(),v={response:g};return this.getWebComponent().getHelper("config").triggerCallback("results.loaded",v),this.getWebComponent().dispatchCustomEvent("results.loaded",v),this.#bm=g,this.#bn=!1,0!==g.hits.length&&(this.getView("root.body.results.found").mountResults(g),this.#bw(),!0)}#bx($,m){let y=m.getResponse();if(!0===this.#bn){let w=this.#bv($,m);return!0===this.getView("root.body.results.found").containsScrollbar()||(this.loadMore(),w)}if(this.#bm=y,this.getView("root.body.results.found").clearResults(),0===y.hits.length)return this.getWebComponent().getHelper("config").triggerCallback("results.empty"),this.getWebComponent().dispatchCustomEvent("results.empty"),this.getView("root").setStateKey("empty"),!1;let b={response:y};this.getWebComponent().getHelper("config").triggerCallback("results.loaded",b),this.getWebComponent().dispatchCustomEvent("results.loaded",b),this.getView("root").setStateKey("results");let x=this.getView("root.body.results.found");return x.mountResults(y),x.resetFocusedIndex(),this.#bw(),!0===x.containsScrollbar()||(this.loadMore(),!0)}#by(S={},E){if(null===E.getError())return this.getView("root.header").hideSpinner(),this.#bx(S,E);return this.#bt(S,E)}#bu(C={}){this.getView("root.header").showSpinner();let U=this.first("input").value.trim(),R=this.#by.bind(this,C);return this.getHelper("typesense").search(U,C).then(R)}#bw(){let V=this.#bm,B=this.getView("root.header.metaBar");return B.set("typesenseSearchResponse",V),B.render(),!0}append(e){let t=this.first("input");return t.value=t.value+e,!0}blur(){return this.first("input").blur(),!0}clear(){return this.first("input").value="",!0}nullifyLastTypesenseSearchResponse(){return this.#bm=null,!0}decrement(){let e=this.first("input");return e.value=e.value.slice(0,-1),!0}focus(){if(!0===this._$annexSearchWidget.disabled())return!1;this.getView("root.body.results.found").clearFocused();let e=this.first("input");return window.annexSearch.ElementUtils.waitForAnimation().then(function(){return!1!==window.annexSearch.ElementUtils.visible(e)&&(e.focus(),!0)}),!0}loadMore(){if(!0===this.#bn)return!1;if(!0===window.annexSearch.FunctionUtils.limitReached(this.loadMore,10,7500)){let e=window.annexSearch.ErrorUtils.getMessage("fieldHeaderView.loadMore.limitReached");return this.error(e),this.getView("root").setStateKey("error"),this.getWebComponent().disable(),!1}this.#bn=!0;if(this.getView("root.body.results.found").getResults().length>=this.#bm.found)return!1;let t=this.#bm?.page??null;if(null===t)return!1;t=parseInt(t,10),++t;let n={};return n.page=t,this.#bu(n),!0}render(){return super.render(),this.#aX(),!0}select(){let e=this.first("input");return window.annexSearch.ElementUtils.waitForAnimation().then(function(){e.select()}),!0}setCaret(){let e=this.first("input"),t=e.value;return e.setSelectionRange(t.length,t.length),!0}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.HeaderView=window.annexSearch.HeaderView||class e extends window.annexSearch.BaseView{#bz=!1;_markup=`
...
</div>`;#a_(){let t=this.#a0.bind(this);return this.click(t),!0}#aX(){return this.#a_(),this.#bA(),!0}#bA(){let n=this.first(".hide"),r=this.#bB.bind(this);return n.addEventListener("click",r),!0}#a0(i){let a;return i.target!==this.first(".hide")&&(this.focus(),!0)}#bB(s){return this.getWebComponent().hide(),!1}#bC(){let o=new window.annexSearch.FieldHeaderView(this._$annexSearchWidget),u=this._$element;return this.setView("field",o),o.mount(u),!0}#bD(){let l=new window.annexSearch.MetaBarHeaderView(this._$annexSearchWidget),c=this._$element;return this.setView("metaBar",l),l.mount(c),!0}blur(){return this.getView("field").blur()}focus(){return this.getView("field").focus()}mount(e){return super.mount(e),this.#bC(),this.#bD(),!0}hideSpinner(){return!1!==this.#bz&&(this.#bz=!1,this.getView("root").setAttribute("data-searching","0"),!0)}render(){return super.render(),this.#aX(),!0}showSpinner(){return!0!==this.#bz&&(this.#bz=!0,this.getView("root").setAttribute("data-searching","1"),!0)}}}),window.annexSearch.DependencyLoader.push(["window.annexSearch.BaseView"],function(){window.annexSearch.MetaBarHeaderView=window.annexSearch.MetaBarHeaderView||class e extends window.annexSearch.BaseView{_markup=`
        <%
            let showing = 0;
