...
<script
    ...
    src="https://cdn.jsdelivr.net/gh/AnnexLabs/AnnexUI@v0.1.6-stable/dist/bundle.min.js"
    defer></script>
...
``` html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/AnnexLabs/AnnexUI@v0.1.6-stable/dist/bundle.min.js" defer></script>
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        let $annexSearchWidget = document.createElement('annex-search-widget');
        $annexSearchWidget.setConfig({
